...
print('________  APERTURA CSV, EXPLORACIÓN Y LIMPIEZA DATAFRAME ACTIVIDAD CLIENTES   __________')
...
#Únicamente llamo a la función para ver los principales estadísticos de las columnas numéricas porque no tiene ninguna columna categórica, salvo Month.
...
#Llamo a la función para cambiar los valores negativos de la columna Salary, entendiendo que se han podido generar erróneamente durante el almacenamiento de los datos.
...
#Llamo a la función para calcular la media y la mediana de la columna Salary y ver a qué valor puedo imputar los nulos.
...
print('______________    UNIÓN DATAFRAMES    _______________')
...
#Llamo a la función para analizar los duplicados. 
duplicados= soporte.analisis_duplicados(df_clientes)
print(duplicados)

print('________________________      OBSERVACIONES     ________________________________')
